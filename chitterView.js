class ChitterView {
  constructor(model, client) {
    ...
    submitButtonCreateUserEl.addEventListener("click", () =>
    ...
    submitButtonLoginUserEl.addEventListener("click", () =>
      this.viewLoginUser()
    );
    ...
    submitButtonLogoutUserEl.addEventListener("click", () =>
      this.viewLogoutUser()
    );
  ...
  displayAllPeeps(allPeepsCollection) {
    ...
    allPeepsCollection.forEach((peep) => {
      ...
      peepContainer.style.cssText =
        "margin-left: 0.25rem;width: calc(100% - 4rem); padding: 1rem 2rem 0.75rem 1.25rem; border-bottom:solid 1px lightgrey";
  ...
  addPeepBody(peep, peepContainer) {
    ...
    peepEl.style.cssText =
      "padding: 0.75rem 1rem 0rem 9rem; font-size:1.15em; font-family: Helvetica; color: grey";
